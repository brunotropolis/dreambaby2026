...
const stats = [
  ...
  { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect width="24" height="24" rx="6" fill="#000000"/><path d="M16.2 10.3V8.1a3.2 3.2 0 01-2.2-1 3.2 3.2 0 01-.8-2.1h-2.1v10.5a1.8 1.8 0 01-1.8 1.7 1.8 1.8 0 01-1.8-1.8 1.8 1.8 0 011.8-1.8c.2 0 .3 0 .5.1V11.4a4 4 0 00-.5 0 4 4 0 00-4 4 4 4 0 004 4 4 4 0 004-4V9.8a5.3 5.3 0 002.9.9v-2.2a3.2 3.2 0 01-2-.2z" fill="white"/></svg>, num: '+650k', lbl: 'seguidores no TikTok' },
