...
const BonusSection = () => (
  <section className="bg-warm py-16">
    <div className="max-w-[1080px] mx-auto px-6 sm:px-10">
      ...
      <div className="bg-primary text-primary-foreground rounded-2xl p-4 px-7 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-3 text-center">
